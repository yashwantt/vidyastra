const school = {
  schoolName: 'Govt Senior Secondary School, Kothi Deora',
  schoolAddress: 'P.O. Ghatti, Tehsil & Distt Solan, Himachal Pradesh, 173223',
  udiseCode: 'qwerty123',
  depttSchoolCode: '123456',
  classes: [
    { value: '6', label: '6' },
    { value: '7', label: '7' },
    { value: '8', label: '8' },
  ...
  all: {
    compulsary: ['English', 'Hindi', 'Science', 'Math', 'SST'],
    choices: [],
  },
  science: {
