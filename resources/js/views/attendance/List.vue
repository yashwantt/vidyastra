<template>
  <div class="app-container">
    ...
    <div class="app-container">
      <el-row class="text-center el-button--primary pad5">
        <el-col :xs="12" :sm="12" :md="6">
          <em>Total: </em><span>{{ total }}</span><br><br>
        </el-col>
        <el-col :xs="12" :sm="12" :md="6">
          <em>Present: </em><span>{{ present }}</span><br><br>
        </el-col>
        <el-col :xs="12" :sm="12" :md="6">
          <em>Absent: </em><span>{{ absent }}</span><br>
        </el-col>
        <el-col :xs="12" :sm="12" :md="6">
          <em>Leave: </em><span>{{ leave }}</span><br>
        </el-col>
      </el-row>
    </div>
    <el-table v-loading="listLoading" :data="list" border highlight-current-row style="width: 100%">
      ...
      <el-table-column fixed="right" label="Marked" align="right">
        <template slot-scope="scope">
          <el-radio-group v-model="attendance[scope.row.at_id]" size="mini" @change="atMark(scope.row.at_id,scope.row.contact,scope.row.fullName)">
    ...
    <div class="app-container">
      <el-row class="text-right el-button--primary pad5">
        <el-col :xs="24" :sm="24" :md="24">
          <el-checkbox v-model="markChecked" @change="markAllPresent(seenNotify)"><span class="text-white">Mark all Present</span></el-checkbox>
        </el-col>
      </el-row>
    </div>
