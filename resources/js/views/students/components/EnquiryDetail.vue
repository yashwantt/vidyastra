        ...
        <el-tabs v-model="activeName" type="card">
          <el-tab-pane label="Fill Information Properly" name="admissionInfo">
            <el-collapse v-model="activeNames">
                ...
                <el-row>
                  ...
                  <el-col :xs="24" :sm="12" :md="6">
                    <el-form-item class="w200" label="Admission Number" prop="admsNumber">
                      <el-input v-model="admissionForm.admsNumber" class="w193" type="input" :disabled="true" />
                    </el-form-item>
                  </el-col>
                </el-row>
                <el-row>
                  <el-col :xs="24" :sm="12" :md="6">
                    <el-row>
                      <el-col :xs="24" :sm="12" :md="12">
                        <el-form-item class="w200" label="Class(Admission For)" prop="class">
                          <el-cascader
                ...
                <el-row>
                  ...
                  <el-col :xs="24" :sm="12" :md="6">
                    <el-form-item class="w200" label="Country" prop="country">
                      <el-input v-model="admissionForm.country" type="input" :disabled="true" />
                    </el-form-item>
                  </el-col>
              ...
              <el-collapse-item name="5" style="display:none">
                <template slot="title">
  ...
  data() {
    return {
      ...
      admissionForm: {
        ...
        doa: '', session: '', type: 'Enquiry', admsNumber: '', class: '', section: '', cwsn: 'No',
